...
class WordDuplication(WordGames): # you implement this and provide docstrings
    """ Class to represent Word Scramble Game
        this class inherits from the base class WordGames
        ...
        Methods: Overidden from the base class method word_play
        The game play happens here
        """

    def word_play(self):
        print("User input duplication is: ")
...
class WordScramble(WordGames): # you implement this and provide docstrings
    ...
    def word_play(self):
        ...
        for word in list_of_words:
            if (len(word) >= 4):
                scramble += word[0] + word[2] + word[1] + word[3:]
            else:
                print("Not enough letters in word to scramble")
